...
<head>
    ...
    <title>Edit Book Category | Kairos Admin</title>
...
<main class="max-w-3xl mx-auto px-6 py-12">
    ...
    <div class="bg-white rounded-[32px] shadow-sm overflow-hidden">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-white/70 mt-1">
                        Update and organize your library collections.
                    </p>
                </div>
        ...
        <div class="p-8">
            ...
            <form method="POST"
                  action="{{ route('admin.book_categories.update', $bookCategory) }}"
                  class="space-y-6">
